...
- **Disiplin & Kaunseling (SSDOP/UBK) module** — infraction logging, severity levels, counseling sessions, new `disiplin`/`kaunselor` roles. Same "needs a scoping conversation" shape as the mentor/case-tracking module above; see `DISCIPLINE_AND_COUNSELING.md` for the reference material and `TASKS.md` T-041.
